...
def datatocsv(current_game_state, combo_id=-1, csv_file='dataset\\game_data.csv'):
    # Compute distances between Player1 and Player2
    x_distance = current_game_state.player1.x_coord - current_game_state.player2.x_coord
    y_distance = current_game_state.player1.y_coord - current_game_state.player2.y_coord
    ...
    row = [
        ...
        x_distance,  # Replaces individual x coords
        y_distance,  # Replaces individual y coords
        ...
        combo_id  # NEW: add combo id (0-9), or -1 if none
    ]
    ...
    header = [
        ...
        # Player 1 state
        'Player1_ID', 'Player1_health', 'X_distance', 'Y_distance',
        ...
        # Player 2 state (simplified)
        'Player2_ID', 'Player2_health',
...
class Bot:
    ...
    def fight(self, current_game_state, player):
        ...
        #     self.run_command([">+^+A", ">+^+A", "!>+!^+!A"], current_game_state.player1)
        #     combo_id = 5
        elif keyboard.is_pressed('g'):
            self.run_command(["<+^+Y", "<+^+Y", "!<+!^+!Y"], current_game_state.player1)
            combo_id = 6
        elif keyboard.is_pressed('h'):
            self.run_command(["<+^+B", "<+^+B", "!<+!^+!B"], current_game_state.player1)
            combo_id = 7
        # elif keyboard.is_pressed('k'):
        #     self.run_command(["v+<", "v+>", "!v+!<"], current_game_state.player1)
        #     combo_id = 8
        # elif keyboard.is_pressed('l'):
        #     self.run_command(["v+R", "v+R", "!v+!R"], current_game_state.player1)
        #     combo_id = 9
        else:
