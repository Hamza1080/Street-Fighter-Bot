...
class GameState:
    ...
    def to_dict(self):
        # Convert the GameState object back to a dictionary form for Player2 dataset
        state_dict = {
            ...
            # Player 1 features (unchanged)
            'Player1_ID': self.player1.player_id,
            'health': self.player1.health,
            'x_coord': self.player1.x_coord,
            'y_coord': self.player1.y_coord,
            ...
            # Player 2 buttons (only present in this dataset)
            'player2_buttons up': int(self.player2.player_buttons.up),
            'player2_buttons down': int(self.player2.player_buttons.down),
            'player2_buttons right': int(self.player2.player_buttons.right),
            'player2_buttons left': int(self.player2.player_buttons.left),
            'player2.player_buttons.A': int(self.player2.player_buttons.A),
            'player2.player_buttons.B': int(self.player2.player_buttons.B),
            'player2.player_buttons.Y': int(self.player2.player_buttons.Y),
            'player2.player_buttons.R': int(self.player2.player_buttons.R),
            'player2.player_buttons.L': int(self.player2.player_buttons.L)
        }
        return state_dict
